...
export interface ExtractedMetric {
  ...
  iconName?: string;
  sourceFile: string;
  sourceLocation?: string; // sheet, cell range, line number, or cell index
}
...
export interface ConflictRecord {
  field: string;               // e.g., "title", "date", "KPI: Revenue Growth"
  values: Array<{
    value: string;
    sourceFile: string;
    location?: string;
...
export interface UniversalCompilerOutput {
  projectType: "Excel Analytics" | "SQL Analytics" | "Power BI" | "Python" | "R" | "Tableau" | "ZIP Package" | "Mixed Analytics" | string;
